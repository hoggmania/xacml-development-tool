                                    ...
                                    <div className="form-group">
                                        ...
                                        <div className="col-sm-2">
                                            <button className="btn btn-default dropdown-toggle"
                                                    type="button"
                                                    data-toggle="dropdown">Select Rule Combining Algorithm
                                            </button>
                                    ...
                                    <form className="form-inline">
                                        ...
                                        <fieldset className="fsStyle">
                                            ...
                                            <div className="form-group col collapse in">
                                                <label className="control-label col-sm-6" for="name">
                                                    Rule Name:</label>
                                                <div className="col-sm-6 ">
                                                    <input type="name" className="form-control" id="name"
                                            ...
                                            <div className="form-group">
                                                <label className="control-label col-sm-6"
                                                       for="display_name">Effect:</label>
                                                <div className="col-sm-2">
                                                    <button className="btn btn-default dropdown-toggle"
                                                            type="button"
                                                            data-toggle="dropdown">Select Effect
                                                    </button>
                                                    <ul className="dropdown-menu">
                                        ...
                                        <fieldset className="fsStyle">
                                            ...
                                            <div className="form-group">
                                                <label className="control-label col-sm-6" for="display_name">Obligation
                                                    Type:</label>
                                                <div className="col-sm-2">
                                                    <button className="btn btn-default dropdown-toggle"
                                                            type="button"
                                                            data-toggle="dropdown">Select Obligation Type
                                                    </button>
                                                    <ul className="dropdown-menu">
                                            ...
                                            <div className="form-group">
                                                <label className="control-label col-sm-6" for="obligationid">
                                                    Id:</label>
                                                <div className="col-sm-6 ">
                                                    <input type="obligationid" className="form-control"
                                                           id="obligationid"
                                            ...
                                            <div className="form-group">
                                                <label className="control-label col-sm-6" for="obligationvalue">
                                                    Value:</label>
                                                <div className="col-sm-6 ">
                                                    <input type="obligationvalue" className="form-control"
                                                           id="obligationvalue"
                                                           placeholder="Enter value"/>
                                                </div>
                                            </div>
